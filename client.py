...
def askPlayerName():
    ...
    canvas1 = Canvas( nameWindow, width = 2000,height = 100)
    canvas1.pack(fill = "both", expand = True)
    # Display image
    canvas1.create_image( 250, -50, image = bg, anchor = "nw")
    canvas1.create_text( screen_width/2, screen_height/5, text = "Enter Name", font=("Chalkboard SE",100), fill="black")
